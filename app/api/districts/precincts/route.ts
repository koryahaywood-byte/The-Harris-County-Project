...
const TIGERWEB =
  ...
  "&outFields=VTD,NAME,SLDLST,SLDUST,GEOID" +
  "&f=geojson" +
  "&geometryPrecision=4" +
  "&outSR=4326" +
    ...
    if (geojson.features) {
      geojson.features = geojson.features.map((f: { properties: Record<string, unknown>; [key: string]: unknown }) => ({
        ...
        properties: {
          ...
          sldlst: f.properties.SLDLST ?? null,   // TX State House district (e.g. "148")
          sldust: f.properties.SLDUST ?? null,   // TX State Senate district (e.g. "006")
