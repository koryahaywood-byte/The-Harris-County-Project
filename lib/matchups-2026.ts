...
export const MATCHUPS_2026: Record<string, Matchup> = {
  ...
  "TX-Comptroller": {
    ...
    detail: "Glenn Hegar left office in July 2026 to become Chancellor of Texas A&M. Don Huffines won the R primary with 58% after Trump endorsed him over Abbott-backed Kelly Hancock, who was serving as acting comptroller. Gov. Abbott then appointed Huffines acting Comptroller effective Aug. 1, 2026 after Hancock announced his resignation, making Huffines a sitting officeholder ahead of the November election; Huffines was formally sworn in Aug. 1, 2026, pledging aggressive audits and declining a state salary, per the Texas Tribune. Sarah Eckhardt (former Travis County Judge), who won the D primary with 60%, has criticized the appointment as bypassing voters. A Texas Southern University poll (July 27-30, 1,200 likely voters) had Huffines leading Eckhardt 46-39. Source: Houston Public Media, July 2, 2026.",
  },
  // ── Top of Ticket ──────────────────────────────────────────────────────────
  "US-Senate": {
    office: "U.S. Senate",
    ...
    detail: "Paxton beat Cornyn in the May runoff. Talarico beat Crockett in the Democratic runoff. Former state rep HD-52 (Austin area). Talarico outraised Paxton in the July semiannual filing, $31.6 million to $9.3 million for the quarter and $72 million to $16.8 million cumulatively since 2025, per a July 20, 2026 Texas Tribune analysis of the finance reports. A Texas Public Opinion Research poll of 1,048 likely voters (July 15-17, released July 28, 2026) had Talarico ahead 45-40, his largest lead of the general-election period, taken after a July 7 Texas Tribune/ProPublica investigation alleged Paxton voted in six elections using a former address. A Texas Southern University Barbara Jordan Center poll (fielded late July, released Aug. 4, 2026) found Talarico leading 79-12 among Black voters and roughly matched his statewide lead. On Aug. 5, 2026 the Texas Tribune reported Talarico voted in five elections using his parents' Travis County address after buying his own home in June 2022, not updating his registration until September 2024; his campaign dismissed the story as a deflection from Paxton's own residency questions rather than answering them directly.",
  },
  "HC-Countywide": {
  ...
  "CD-18": {
    ...
    lean: "safe-d",
    sides: [
      { name: "Christian Menefee",       party: "D", incumbent: true,  gender: "M", note: "Won May runoff over Al Green 71-29%; sworn in after Sylvester Turner's death; seeking first full term" },
