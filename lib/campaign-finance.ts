...
export const FINANCE_DATA: CandidateFinance[] = [
  ...
  { name: "Laura Garcia DeLeon",   office: "State Rep HD-140 (R nominee)",   level: "state",    party: "R", cash: 0,     asOf: "pending", incumbent: false, filingUrl: TEC("Laura Garcia DeLeon") },
  ...
  { name: "Dave Bennett",          office: "State Rep HD-149 (R nominee)",   level: "state",    party: "R", cash: 0,     asOf: "pending", incumbent: false, filingUrl: TEC("Dave Bennett") },
  ...
  { name: "Alexandria Butler",     office: "State Rep HD-146 (R nominee)",   level: "state",    party: "R", cash: 0,     asOf: "pending", incumbent: false, filingUrl: TEC("Alexandria Butler") },
  ...
  { name: "Brent Haynes",          office: "182nd District Court (R nominee)", level: "county",   party: "R", cash: 0,     asOf: "pending",  incumbent: false, filingUrl: TEC("Brent Haynes") },
