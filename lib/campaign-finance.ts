...
export const FINANCE_DATA: CandidateFinance[] = [
  ...
  { name: "Paul Bettencourt",      office: "State Senator SD-7",             level: "state",    party: "R", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Paul Bettencourt") },
  ...
  { name: "Harold Dutton Jr.",      office: "State Rep HD-142",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Harold Dutton Jr.") },
  { name: "Gene Wu",               office: "State Rep HD-137",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Gene Wu") },
  { name: "Jolanda Jones",         office: "State Rep HD-147",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Jolanda Jones") },
  { name: "Lauren Ashley Simmons", office: "State Rep HD-146",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Lauren Ashley Simmons") },
  { name: "Christina Morales",     office: "State Rep HD-145",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Christina Morales") },
  { name: "Charlene Ward Johnson", office: "State Rep HD-139",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Charlene Ward Johnson") },
  { name: "Jon Rosenthal",         office: "State Rep HD-135",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Jon Rosenthal") },
  { name: "Lacey Hull",            office: "State Rep HD-138",               level: "state",    party: "R", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Lacey Hull") },
  { name: "Tom Oliverson",         office: "State Rep HD-130",               level: "state",    party: "R", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Tom Oliverson") },
  { name: "Dennis Paul",           office: "State Rep HD-129",               level: "state",    party: "R", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Dennis Paul") },
  ...
  { name: "Penny Morales Shaw",    office: "State Rep HD-148",               level: "state",    party: "D", cash: 0,          asOf: "pending",  incumbent: true,  filingUrl: TEC("Penny Morales Shaw") },
  ...
  { name: "Morgan Luttrell",      office: "U.S. Rep CD-08",                 level: "federal",  party: "R", cash: 0,         asOf: "pending",  incumbent: true,  filingUrl: FEC("H2TX08226") },
  { name: "Laura Jones",          office: "U.S. Rep CD-08 (D nominee)",     level: "federal",  party: "D", cash: 0,         asOf: "pending",  incumbent: false },
  { name: "Troy Nehls",           office: "U.S. Rep CD-22",                 level: "federal",  party: "R", cash: 0,         asOf: "pending",  incumbent: true,  filingUrl: FEC("H0TX22227") },
  { name: "Marquette Greene-Scott",office: "U.S. Rep CD-22 (D nominee)",   level: "federal",  party: "D", cash: 0,         asOf: "pending",  incumbent: false },
