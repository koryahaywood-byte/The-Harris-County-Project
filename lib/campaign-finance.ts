...
export const FINANCE_DATA: CandidateFinance[] = [
  ...
  { name: "Paul Bettencourt",      office: "State Senator SD-7 (not on 2026 ballot)", level: "state", party: "R", cash: 0, asOf: "pending", incumbent: true, filingUrl: TEC("Paul Bettencourt") },
  ...
  { name: "Hubert Vo",             office: "State Rep HD-149 (lost D runoff; holds seat through Jan 2027)", level: "state", party: "D", cash: 0, asOf: "pending", incumbent: true, filingUrl: TEC("Hubert Vo") },
  { name: "Alma Allen",           office: "State Rep HD-131 (not seeking reelection)", level: "state", party: "D", cash: 0, asOf: "pending", incumbent: true, filingUrl: TEC("Alma Allen") },
  ...
  { name: "Jose Maldonado",        office: "District Clerk (D nominee)",     level: "county",   party: "D", cash: 0,         asOf: "pending",  incumbent: false, filingUrl: "https://ethics.harrisvotes.com/CampaignFinanceReports/COR.aspx" },
  { name: "Chris Daniel",          office: "District Clerk (R nominee)",     level: "county",   party: "R", cash: 0,         asOf: "pending",  incumbent: false, filingUrl: "https://ethics.harrisvotes.com/CampaignFinanceReports/COR.aspx" },
  { name: "Jacqueline Lucci Smith", office: "County Attorney (R nominee)",   level: "county",   party: "R", cash: 0,         asOf: "pending",  incumbent: false, filingUrl: "https://ethics.harrisvotes.com/CampaignFinanceReports/COR.aspx" },
  ...
  { name: "Mike Wolfe",            office: "County Clerk (R nominee)",       level: "county",   party: "R", cash: 0,         asOf: "pending",  incumbent: false, filingUrl: "https://ethics.harrisvotes.com/CampaignFinanceReports/COR.aspx" },
  ...
  { name: "DaSean Jones",       office: "180th District Court (not seeking reelection)", level: "county",  party: "D", cash: 0, asOf: "pending", incumbent: true,  filingUrl: TEC("DaSean Jones") },
