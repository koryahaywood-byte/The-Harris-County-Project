...
export const FINANCE_DATA: CandidateFinance[] = [
  ...
  { name: "Bob Wolfe",             office: "JP PCT 5 PL 2 (lost R primary to Mark Fury)",    level: "county", party: "R", cash: 0, asOf: "pending", incumbent: false, filingUrl: "https://ethics.harrisvotes.com/CampaignFinanceReports/COR.aspx" },
