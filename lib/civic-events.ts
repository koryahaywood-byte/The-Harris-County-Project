...
export const EVENTS: CivicEvent[] = [
  ...
  { id: "lege-shied-jul28-26", title: "Senate Higher Education Committee Interim Hearing", date: "2026-07-28", category: "Legislature", description: "Senate Higher Education Committee monitors implementation of SB 37 (university governance/curriculum review) and HB 127 (barring foreign-adversary ties at Texas institutions), and examines the Public Junior College State Finance Program funding formula that sets state aid to Houston Community College and Lone Star College.", importance: "normal" },
