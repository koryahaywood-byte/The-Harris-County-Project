...
const JP_BENCH: Record<string, { jps: { name: string; place: number; party: "D" | "R" }[]; constable: { name: string; party: "D" | "R" } }> = {
  "1": { jps: [{ name: "Eric William Carter", place: 1, party: "R" }, { name: "Steve Duble", place: 2, party: "R" }],        constable: { name: "Alan Rosen", party: "D" } },
  "2": { jps: [{ name: "Jo Ann Delgado", place: 1, party: "D" },     { name: "Dolores Lozano", place: 2, party: "D" }],      constable: { name: "Jerry Garcia", party: "D" } },
  "3": { jps: [{ name: "Joe Stephens", place: 1, party: "R" },       { name: "Lucia Bates", place: 2, party: "R" }],         constable: { name: "Sherman Eagleton", party: "D" } },
