...
export const KAY_EVENTS: KayEvent[] = [
  ...
  // ── Synced 2026-07-25 ──────────────────────────────────────────────────────
  { id: "mk-65", date: "2026-07-25", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Prayer Vigil for Lorenzo Salgado", host: "Justice for Lorenzo", venue: "Immaculate Heart of Mary Parish",
    address: "6820 Canal St", note: "Procession then 7:30 PM prayer vigil", rsvp: "info.mwdc@gmail.com",
    category: "Organizing", channel: ["RSVP"] },
  { id: "mk-66", date: "2026-07-25", startTime: "10:00", endTime: "12:00", timeLabel: "10:00 AM–12:00 PM",
    title: "ICE Out of Texas: Mass March for Lorenzo", host: "Justice for Lorenzo", address: "1121 Franklin St",
    rsvp: "actionnetwork.org/events/ice-out-of-houston", category: "Organizing", channel: ["Website"] },
  { id: "mk-67", date: "2026-07-25", startTime: "12:00", endTime: "14:00", timeLabel: "12:00–2:00 PM",
    title: "The Affordability Listening Tour", host: "Congressman Christian Menefee", venue: "Julia C. Hester House",
    address: "2020 Solo St", category: "Town Hall", channel: ["RSVP"] },
  { id: "mk-68", date: "2026-07-27", startTime: "17:00", endTime: "20:00", timeLabel: "5:00–8:00 PM",
    title: "Campaign Open House", host: "Letitia Plummer for County Judge", venue: "Team Plummer HQ",
    address: "5445 Almeda Rd", category: "Organizing", channel: ["Mobilize"] },
  { id: "mk-69", date: "2026-07-28", startTime: "19:30", timeLabel: "7:30 PM",
    title: "Jill Biden Book Tour", host: "Progressive Forum Houston", venue: "Wortham Theater, Cullen Theater",
    address: "501 Texas Ave", note: "Former First Lady's book tour stop",
    rsvp: "ci.ovationtix.com/36901/production/1279894", category: "Town Hall", channel: ["Website"] },
  { id: "mk-70", date: "2026-07-31", startTime: "18:00", endTime: "23:00", timeLabel: "6:00–11:00 PM",
    title: "Wine Down: Grand Finale", host: "HMS TV", address: "7305 Navigation Blvd",
    note: "40th anniversary celebration, live taping. $40", rsvp: "713.524.7700 / info@hmstv.org",
    category: "Social", channel: ["RSVP"] },
  { id: "mk-71", date: "2026-08-01", startTime: "14:00", endTime: "16:00", timeLabel: "2:00–4:00 PM",
    title: "Campaign Kickoff Parties", host: "Shaun Finney for Congress",
    note: "Two locations: 26009 Budde Rd Ste B300, Spring; and Black Walnut, 9000 Trails Dr, The Woodlands",
    rsvp: "mobilize.us/shaunfinnieforcongress/event/992414", category: "Organizing", channel: ["Mobilize"] },
  { id: "mk-72", date: "2026-08-01", startTime: "15:00", endTime: "19:00", timeLabel: "3:00–7:00 PM",
    title: "HBCU Family Fun Fest", host: "Honorary Chair Ron Reynolds", venue: "Kitty Hollow Park",
    address: "9555 Hwy 6, Missouri City", category: "Social", channel: ["Facebook"] },
  { id: "mk-73", date: "2026-08-15", startTime: "12:00", timeLabel: "12:00 PM (Noon)",
    title: "Greater East End Townhall: Know Your Rights, Financial Planning & Property Tax",
    host: "Greater East End", venue: "Houston Media Source", address: "7305 Navigation Blvd",
    category: "Town Hall", channel: ["Facebook"] },
  { id: "mk-74", date: "2026-10-29", startTime: "19:00", timeLabel: "7:00 PM",
    title: "Roast & Toast: CM Mario Castillo", host: "Harris County Tejano Democrats", venue: "The Chifley Hotel",
    address: "2400 W Loop South", note: "Ticketed", category: "Gala", channel: ["Facebook", "Mobilize"], channelVerified: true },
  { id: "mk-75", date: "2026-08-03", startTime: "19:00", timeLabel: "7:00 PM",
    title: "Monthly Meeting", host: "CD 18 Democrats", venue: "Virtual (Zoom)",
    category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-76", date: "2026-08-04", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Organizing Night at the Houston HQ", host: "Texas Together", address: "4119 Montrose Blvd #400",
    category: "Organizing", channel: ["Mobilize"] },
  { id: "mk-77", date: "2026-08-05", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting", host: "Houston LGBTQ+ Political Caucus", venue: "Montrose Center",
    address: "401 Branard St", category: "Club Meeting", channel: ["Website", "Facebook"], channelVerified: true },
  { id: "mk-78", date: "2026-08-05", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting", host: "CyFair Democrats", venue: "Romero's Restaurant",
    address: "15703 Longenbaugh Dr #A", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-79", date: "2026-08-10", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting", host: "Bellaire Braeswood Democrats", venue: "Rajun Cajun",
    address: "4302 Richmond St", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-80", date: "2026-08-11", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Engage for the Midterms", host: "Cypress Tomball Democrats", address: "15006 Lakewood Forest Dr",
    category: "Organizing", channel: ["Facebook", "Mobilize"] },
  { id: "mk-81", date: "2026-08-11", startTime: "18:00", timeLabel: "6:00 PM",
    title: "Monthly Meeting", host: "Baytown Area Democrats", note: "Address provided upon RSVP",
    category: "Club Meeting", channel: ["RSVP"] },
  { id: "mk-82", date: "2026-08-13", startTime: "19:00", timeLabel: "7:00 PM",
    title: "Monthly Meeting", host: "Harris County Tejano Democrats", address: "2101 South St",
    note: "Precinct 2", category: "Club Meeting", channel: ["Facebook", "Mobilize"], channelVerified: true },
  { id: "mk-83", date: "2026-08-15", startTime: "19:00", timeLabel: "7:00 PM",
    title: "PRIDE Parade", host: "Houston LGBTQ+ Political Caucus", venue: "Houston City Hall",
    address: "901 Bagby St", category: "Social", channel: ["Website", "Facebook"], channelVerified: true },
  { id: "mk-84", date: "2026-08-16", startTime: "15:30", timeLabel: "3:30 PM",
    title: "Knock Doors with the Candidates", host: "Teneshia Hudspeth, Dolores Lozano & Shannon Dicely",
    venue: "South Belt Elementary", address: "1801 Riverstone Ranch Rd",
    note: "Regroup at 6:00 PM at Papagayos Tex Mex", category: "Organizing", channel: ["Mobilize"] },
  { id: "mk-85", date: "2026-08-17", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting · Speaker Christian Menefee", host: "Meyerland Dems", venue: "Faith Lutheran Church",
    address: "4600 Bellaire Blvd", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-86", date: "2026-08-18", startTime: "18:30", timeLabel: "6:30 PM",
    title: "General Body Meeting · Speaker State Rep. Ron Reynolds", host: "HBAD", venue: "Small Business Wealth",
    address: "2787 El Camino St", note: "Precinct 1", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-87", date: "2026-08-18", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting · Speaker Commissioner Lesley Briones", host: "RoadWomen", venue: "St. Stephen's",
    address: "1800 Sul Ross St", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-88", date: "2026-08-18", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting", host: "CD 9 Democrats", venue: "Flukinger Community Center",
    address: "16003 Lorenzo St, Channelview", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-89", date: "2026-08-19", startTime: "18:00", timeLabel: "6:00 PM",
    title: "Monthly Meeting", host: "Spring Branch Democrats", venue: "Taqueria Arandas",
    address: "1840 Wirt Rd", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-90", date: "2026-08-23", startTime: "16:00", endTime: "18:00", timeLabel: "4:00–6:00 PM",
    title: "Grand Opening of the Democratic HQ", host: "Bay Area Democratic Movement", address: "17301 El Camino Real",
    note: "Free event, open to the public", rsvp: "BayAreaDemocraticMovement.org",
    category: "Social", channel: ["Website", "Facebook"] },
  { id: "mk-91", date: "2026-08-24", startTime: "17:00", timeLabel: "5:00 PM",
    title: "Summer Social", host: "Spring Branch Democrats", venue: "Memorial Forest Club",
    address: "12122 Memorial Dr", note: "Private event", category: "Social", channel: ["Facebook"] },
  { id: "mk-92", date: "2026-08-27", startTime: "19:00", timeLabel: "7:00 PM",
    title: "Fall Fundraiser", host: "HBAD", venue: "POST Houston", address: "401 Franklin St",
    note: "Tickets start at $50", rsvp: "secure.actblue.com/donate/fundraiserhbad",
    category: "Fundraiser", channel: ["Eventbrite"] },
  { id: "mk-93", date: "2026-09-08", startTime: "18:00", timeLabel: "6:00 PM",
    title: "Monthly Meeting", host: "Baytown Area Democrats", note: "Address provided upon RSVP",
    category: "Club Meeting", channel: ["RSVP"] },
  { id: "mk-94", date: "2026-09-15", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Speed Dating with the Candidates", host: "RoadWomen", venue: "St. Stephen's",
    address: "1800 Sul Ross St", category: "Club Meeting", channel: ["Facebook"] },
  { id: "mk-95", date: "2026-09-15", startTime: "18:30", timeLabel: "6:30 PM",
    title: "Monthly Meeting", host: "CD 9 Democrats", venue: "Flukinger Community Center",
    address: "16003 Lorenzo St, Channelview", category: "Club Meeting", channel: ["Facebook"] },
];
